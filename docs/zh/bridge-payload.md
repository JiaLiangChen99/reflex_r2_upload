...
| [文档首页](../README.md) | [配置](configuration.md) | **Bridge** | [私有桶](private-bucket.md) | [架构](architecture.md) |
...
| `INVALID_PAYLOAD` | `parse_upload_payload` 解析失败 |
...
- presigned PUT URL → 短命敏感，不进入 bridge

---

| [← 配置](configuration.md) | [文档首页](../README.md) | [私有桶 →](private-bucket.md) |
